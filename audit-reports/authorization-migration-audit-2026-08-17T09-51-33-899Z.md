...
Generated: 2026-08-17T09:51:33.931Z

## Executive Summary

- Files scanned: **721**
- Total findings: **913**
- Migration risk score: **4065**
...
| MUTATION_RISK | 288 |
| LEGACY_ROLE | 126 |
| LEGACY_ROLE_GUARD | 119 |
| ROLE_SCOPE_REVIEW | 102 |
...
There are **230** findings requiring human classification.
...
`src/components/AppSidebarClient.tsx:243`

```ts
    239 |       icon: <ClipboardList size={18} className="text-amber-500" />,
    240 |       label: "Assessments",
    241 | 
    242 |       href:
>   243 |         role === "student"
    244 |           ? "/student/assessments"
    245 |           : role === "parent"
    246 |             ? "/parent/assessments"
    247 |             : "/list/assessments",
```
...
`src/components/AppSidebarClient.tsx:245`
...
`src/components/AppSidebarClient.tsx:284`

```ts
    280 |     {
    281 |       icon: <FileText size={18} className="text-blue-600" />,
    282 | 
    283 |       label:
>   284 |         role === "student"
    285 |           ? "My Report Cards"
    286 |           : role === "parent"
    287 |             ? "Children's Reports"
    288 |             : role === "teacher"
```
...
`src/components/AppSidebarClient.tsx:286`
...
>   286 |           : role === "parent"
    287 |             ? "Children's Reports"
    288 |             : role === "teacher"
    289 |               ? "Class Report Cards"
    290 |               : "Report Command Centre",
```
...
`src/components/AppSidebarClient.tsx:288`
...
`src/components/AppSidebarClient.tsx:293`
...
`src/components/AppSidebarClient.tsx:295`
...
`src/components/AppSidebarClient.tsx:297`
