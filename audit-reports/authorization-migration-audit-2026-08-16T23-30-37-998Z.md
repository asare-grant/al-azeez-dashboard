...
Generated: 2026-08-16T23:30:38.035Z

## Executive Summary

- Files scanned: **702**
- Total findings: **957**
- Migration risk score: **4198**
- Good RBAC signals: **66**
...
|---|---:|
| MUTATION_RISK | 288 |
| LEGACY_ROLE_GUARD | 181 |
| LEGACY_ROLE | 126 |
| AUTH_ONLY_REVIEW | 102 |
| ROLE_SCOPE_REVIEW | 101 |
| CLAIMS | 81 |
| CENTRALIZED | 66 |
| LEGACY_ROUTE_GUARD | 9 |
| PREFIX_POLICY | 2 |
| REDIRECT | 1 |
...
**File:** `src/lib/auth/route-permissions.ts:37`
...
```ts
     33 |  * Fine-grained authorization belongs to Prisma RBAC
     34 |  * permissions through getCurrentAccessActor() /
     35 |  * getCurrentAccessContext().
     36 |  */
>    37 | export async function requireRouteRole(
     38 |   allowedRoles:
     39 |     readonly AppRole[],
     40 | ) {
     41 |   const profile =
...
**File:** `src/lib/auth/route-permissions.ts:66`
...
```ts
     62 |    * therefore be accepted anywhere an old route explicitly
     63 |    * allows Admin.
     64 |    */
     65 |   const superAdminInheritedAccess =
>    66 |     role ===
     67 |       "super_admin" &&
     68 |     allowedRoles.includes(
     69 |       "admin",
     70 |     );
```
...
There are **229** findings requiring human classification.
