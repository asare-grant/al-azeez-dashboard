...
export async function getReportCardGenerationReadiness({
  ...
  if (
    ...
    return {
      ...
      issues: [
        "The selected class or school term could not be found.",
      ],
    };
  }
