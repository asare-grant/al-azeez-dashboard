...
import { Banknote, CalendarDays, ChartBar, Users } from "lucide-react";
...
export default async function FeedingFeeDashboardPage() {
  ...
  const [
    ...
    prisma.feedingFeeStudent.count(),

    prisma.feedingFeePayment.findMany({
      include: {
        student: {
          select: {
            name: true,
  ...
  return (
    <div className="flex flex-col gap-6 p-4">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-xl font-semibold">Feeding Fee Dashboard</h1>
          <p className="text-sm text-gray-500">
            View feeding fee payments, daily totals, weekly totals and term
            revenue.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 gap-6 xl:grid-cols-2">
        <div className="rounded-md bg-white p-4 shadow-sm">
          <h2 className="mb-4 text-lg font-semibold">Feeding Fee by Day</h2>
        ...
        <div className="rounded-md bg-white p-4 shadow-sm">
          <h2 className="mb-4 text-lg font-semibold">Feeding Fee by Week</h2>
      ...
      <div className="rounded-md bg-white p-4 shadow-sm">
        <h2 className="mb-4 text-lg font-semibold">Recent Feeding Payments</h2>
              ...
              {recentPayments.length === 0 && (
                <tr>
                  <td className="p-3 text-gray-500" colSpan={5}>
                    No feeding fee payment recorded yet.
                  </td>
                </tr>
              )}
            </tbody>
