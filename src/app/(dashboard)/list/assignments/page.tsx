...
import { requireAssignmentListAccess } from "@/lib/assignments/auth";
...
export default async function AssignmentListPage(props: {
  ...
  const access = await requireAssignmentListAccess();
  ...
  if (!access.global) {
    const scopeFilters: Prisma.AssignmentWhereInput[] = [];
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex w-full flex-col items-center gap-4 md:w-auto md:flex-row">
          ...
          <div className="flex items-center gap-4 self-end">
            ...
            {canManage ? <FormModal table="assignment" type="create" /> : null}
          </div>
        </div>
      </div>
