...
import type { TeacherStudentSubmissionReview } from "@/lib/assessments/types";
  ...
  return (
    <div className="print:bg-white min-h-screen bg-slate-50 p-4 sm:p-6 lg:p-8">
      <div className="print:max-w-none mx-auto max-w-[1600px]">
        ...
        <StudentSubmissionReviewHeader data={data} />
          ...
          <>
            <div className="mt-6 grid items-start gap-5 xl:grid-cols-[300px_minmax(0,1fr)_340px]">
              <div className="space-y-5">
                ...
                <StudentAttemptComparison comparison={data.comparison} />
              </div>

              <div className="min-w-0 space-y-5">
                <StudentSubmissionSummary data={data} />

                <StudentQuestionReview questions={data.questions} />
              </div>
              ...
              <div className="xl:sticky xl:top-6">
                {attempt ? (
                  <TeacherFeedbackPanel
                    ...
                    initialFeedback={attempt.teacherFeedback}
