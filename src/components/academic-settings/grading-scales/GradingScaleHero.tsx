              ...
              <div className="mt-4 flex items-start gap-4 sm:gap-5">
                ...
                <div className="min-w-0">
                  ...
                  <p className="mt-4 max-w-3xl text-sm font-medium leading-7 text-slate-300 sm:text-[15px]">
                    Design and control
                    the score boundaries,
                    grade labels and academic
                    remarks used by the school&apos;s
              ...
              <div className="mt-3 flex items-start gap-3 rounded-[18px] border border-white/[0.07] bg-white/[0.035] p-3.5">
                ...
                <div className="min-w-0">
                  ...
                  <p className="mt-1 text-xs font-black text-white">
                    {gradingEngineReady
                      ? "Grading standards available"
                      : "Grading configuration required"}
                  </p>

                  <p className="mt-1 text-[10px] font-medium leading-4 text-slate-400">
                    {gradingEngineReady
                      ? "Active grading scales are available for academic calculations and report cards."
                      : "Create and activate a grading scale before using it within academic calculations."}
                  </p>
                </div>
              </div>
