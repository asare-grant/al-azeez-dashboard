        ...
        <div className="grid gap-8 xl:grid-cols-[minmax(0,1fr)_420px] xl:items-center">
          ...
          <div className="max-w-3xl">
            ...
            <p className="mt-5 max-w-2xl text-sm font-medium leading-7 text-slate-300 sm:text-[15px]">
              Validate academic records, inspect subject-level
              readiness and generate secure report-card snapshots
              from the school&apos;s official academic data.
            </p>

            <div className="mt-6 flex flex-wrap gap-2">
              <GenerationFeature
                icon={ShieldCheck}
                label="Validated academic data"
              />

              <GenerationFeature
                icon={BookOpenCheck}
                label="Subject readiness checks"
              />

              <GenerationFeature
                icon={LockKeyhole}
                label="Protected report history"
              />
            </div>
          </div>
              ...
              <div className="flex items-center justify-between gap-4 border-b border-white/[0.08] pb-4">
                <div>
                  ...
                  <p className="mt-1 text-[11px] font-medium text-slate-400">
                    Current academic period readiness
                  </p>
                </div>
                  ...
                  className={`flex h-10 w-10 items-center justify-center rounded-2xl border ${
                    readiness?.ready
                      ...
                      : readiness
                        ...
                        : "border-white/[0.07] bg-white/[0.06] text-blue-200"
                  }`}
                >
                  {readiness?.ready ? (
