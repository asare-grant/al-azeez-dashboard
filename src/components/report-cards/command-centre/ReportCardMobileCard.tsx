...
export default function ReportCardMobileCard({
  ...
  return (
    <article className="rounded-[24px] border border-slate-200 bg-white p-5 shadow-[0_16px_45px_rgba(15,23,42,0.05)] xl:hidden">
      ...
      <div className="mt-5 grid grid-cols-2 gap-2 sm:grid-cols-3">
        ...
        <Link
          ...
          className="inline-flex h-10 items-center justify-center gap-2 rounded-xl border border-blue-200 bg-blue-50 px-3 text-xs font-black text-blue-700 transition hover:bg-blue-100"
        >
